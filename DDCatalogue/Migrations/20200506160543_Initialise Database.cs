        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(nullable: false),
                    LocationMunicipalityId = table.Column<int>(nullable: true),
                    BuildingId = table.Column<int>(nullable: true),
                    PlayerName = table.Column<string>(nullable: true),
                    Background = table.Column<string>(nullable: true),
                    Faction = table.Column<string>(nullable: true),
                    Race = table.Column<string>(nullable: true),
                    Monster_LocationMunicipalityId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CharacterBase_Buildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "BuildingId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CharacterBase_Npcs_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Npcs",
                        principalColumn: "NpcId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterBase_Player_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Player",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterBase_Municipalities_LocationMunicipalityId",
                        column: x => x.LocationMunicipalityId,
                        principalTable: "Municipalities",
                        principalColumn: "MunicipalityId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CharacterBase_Buildings_Monster_BuildingId",
                        column: x => x.Monster_BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "BuildingId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CharacterBase_Municipalities_Monster_LocationMunicipalityId",
                        column: x => x.Monster_LocationMunicipalityId,
                        principalTable: "Municipalities",
                        principalColumn: "MunicipalityId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dungeons_Municipalities_MunicipalityId",
                        column: x => x.MunicipalityId,
                        principalTable: "Municipalities",
                        principalColumn: "MunicipalityId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterBase_BuildingId",
                table: "CharacterBase",
                column: "BuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_CharacterBase_LocationMunicipalityId",
                table: "CharacterBase",
                column: "LocationMunicipalityId");

            migrationBuilder.CreateIndex(
                name: "IX_CharacterBase_Monster_BuildingId",
                table: "CharacterBase",
                column: "Monster_BuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_CharacterBase_Monster_LocationMunicipalityId",
                table: "CharacterBase",
                column: "Monster_LocationMunicipalityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dungeons_MunicipalityId",
                table: "Dungeons",
                column: "MunicipalityId");
