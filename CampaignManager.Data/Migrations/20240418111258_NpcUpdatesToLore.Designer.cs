...
namespace CampaignManager.Data.Migrations
{
    ...
    [Migration("20240418111258_NpcUpdatesToLore")]
    partial class NpcUpdatesToLore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Creatures.Npc", b =>
                {
                    ...
                    b.Property<NpcAttributes>("Attributes")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Joins.NpcNpc", b =>
                {
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Joins.NpcPc", b =>
                {
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Joins.NpcNpc", b =>
                {
                    b.HasOne("CampaignManager.Data.Model.Creatures.Npc", "From")
                        .WithMany("NpcRelationShipTo")
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CampaignManager.Data.Model.Creatures.Npc", "To")
                        .WithMany("NpcRelationShipsFrom")
                        .HasForeignKey("ToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Joins.NpcPc", b =>
                {
                    b.HasOne("CampaignManager.Data.Model.Creatures.Npc", "Npc")
                        .WithMany("PcRelationships")
                        .HasForeignKey("NpcId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CampaignManager.Data.Model.Creatures.Pc", "Pc")
                        .WithMany()
                        .HasForeignKey("PcId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Locations.Continent", b =>
                {
                    ...
                    b.HasOne("CampaignManager.Data.Model.Locations.World", "World")
                        .WithMany("Continents")
            ...
            modelBuilder.Entity("CampaignManager.Data.Model.Creatures.Npc", b =>
                {
                    b.Navigation("NpcRelationShipTo");

                    b.Navigation("NpcRelationShipsFrom");

                    b.Navigation("PcRelationships");
                });
